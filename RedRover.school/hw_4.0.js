...
// // -----------------------------------------------------
// console.log ('2) ===================================')
// let newStr2 = ''                                // первоначальный отступ 
// let x = 5                                       // для количества итераций
// let space = ' '                                 // пробелы для отступов
// for (let i = 1; i <= x; i ++){                  // итерации вниз (количество строчек)
//     newStr2 += space.repeat (x - i)             // метод .repeat возвращает (повторяет) количество переменных (x - i)
//     for (let j = 1; j <= i; j++){               // итерации вправо
//         newStr2 += j
//     }
